...
public class PutRequest {
    ...
    public void putRequestMethod() {
        ...
        Response response = req.request(Method.PUT, "/api/users/2"); // Updating the request,and store the response in a var.


        // Getting the status code and verifying the status code
        int resCode = response.getStatusCode();
        System.out.println("STATUS CODE IS:" + resCode);
        Assert.assertEquals(200, resCode);            //status code is 200 for updating
